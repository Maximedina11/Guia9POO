...
// la cual deberá contener como atributos, un vector con la palabra 
// a buscar, la cantidad de letras encontradas y la cantidad jugadas 
// máximas que puede realizar el usuario.
...
public class Ahorcado {
    ...
    public Ahorcado(String palabra, int jugadasMaximas) {
        ...
        this.oportunidadesRestantes = jugadasMaximas;
    }
